...
from connectors.UDPLINK.YAPLCObject import YAPLCObject_UDP


_UDPLINKSession = None
errCount = 0
...
def _UDPLINK_connector_factory(cls, uri, confnodesroot):
    """
    ...
    class SocketPLCObjectProxy(object):
        def __init__(self):
            ...
            _SocketSession = YAPLCObject_UDP(confnodesroot, ip)
...
UDPLINK_connector_factory = partial(_UDPLINK_connector_factory, None)
