...
from plcopen.types_enums import ITEM_PROJECT, ITEM_DATATYPE, ITEM_POU, ITEM_TRANSITION, ITEM_ACTION, \
    ITEM_RESOURCE, ITEM_CONFIGURATION
...
class SearchResultPanel(wx.Panel):
    ...
    def OnSearchResultsTreeItemActivated(self, event):
        '''
        @defgroup 定位搜索结果
        @event wx.EVT_TREE_ITEM_ACTIVATED'''
